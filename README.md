...
- <img src="https://cdn.jsdelivr.net/npm/@primer/octicons/build/svg/rss-16.svg" width="16" height="16" /> [**Daily threat briefs**](https://github.com/Pranith-Jain/daily-threat-brief) — CVEs, KEV, campaigns, supply-chain, IOC families. Fully automated.
- <img src="https://cdn.jsdelivr.net/npm/@primer/octicons/build/svg/book-16.svg" width="16" height="16" /> [**Case-study blog**](https://pranithjain.qzz.io/blog) — autonomous discover → score → QA → publish pipeline.
- <img src="https://cdn.jsdelivr.net/npm/@primer/octicons/build/svg/globe-16.svg" width="16" height="16" /> [**Live threat-intel platform**](https://pranithjain.qzz.io/threatintel) — ransomware, IOC firehose, actor timelines, feed health.
